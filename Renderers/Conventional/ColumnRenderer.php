...
{
	/** @var \DataGrid\Renderers\IColumnRenderer */
	protected $gridRenderer;


	/**
	 * @param \DataGrid\Renderers\Conventional $gridRenderer
	 */
	public function __construct(\DataGrid\Renderers\Conventional $gridRenderer)
	{
